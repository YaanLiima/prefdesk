        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://www.santoanastacio.sp.gov.br/portal/privacidade');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://www.santoanastacio.sp.gov.br/portal/servicos/1085/tecnologia-da-informaca/');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
              ...
              Container(
                decoration: const BoxDecoration(color: Color(0xFF16833A)),
                padding:
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Prefeitura Municipal de Santo Anastácio\n$license',

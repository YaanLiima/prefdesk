...
class MyTheme {
  ...
  static const Color accent = Color(0xFF16833A);
  static const Color accent50 = Color(0x7716833A);
  static const Color accent80 = Color(0xAA16833A);
  ...
  static const Color button = Color(0xFF279847);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://www.instagram.com/yan_liima/'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
